...
<body>
		...
		<c:if test="${param.error != null}">
             <div class="alert alert-danger">
                 Invalid UserName and Password ,or error dy-code.
             </div>
         </c:if>
     ...
     <div class="row">
		<div class="col-md-6 col-md-offset-2">	
			<h2>User Login Form...login</h2>
			<form:form id="loginForm" method="post" action="${rootURL}login/form" modelAttribute="user"
		class="form-horizontal" role="form" cssStyle="width: 800px; margin: 0 auto;">
		  ...
		  <div class="form-group">
			...
			<div class="form-group">
				<label for="dy_code" class="col-sm-2 control-label">Dy-Code*</label>
				<div class="col-sm-4">
					<input type="text" id="dy_code" name="dy_code" class="form-control" placeholder="dynamic code must be 888" />
				</div>
			</div>
		  <div class="form-group">
